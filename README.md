...
See the [LICENSE](https://github.com/phalcon/cphalcon/blob/master/LICENSE.md) file for license rights and limitations (BSD-3). Additional licenses of packages that Phalcon uses, is inspired by or has adapted is located in the [3rdparty/licenses][https://github.com/phalcon/cphalcon/blob/master/3rdparty/licenses] directory.
